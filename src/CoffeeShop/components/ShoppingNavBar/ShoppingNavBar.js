      ...
      <div className="navBar__buttons">
        <div className="navBar__buttons__shoppingCart">
          <IconButton
            ...
            className="navBar__buttons-iconButton"
          >
            <ShoppingCartIcon className="navBar__buttons-btn" />
          </IconButton>
          {itemsInCart > 0 ? (
            <div className="howManyItemsInCart">{itemsInCart}</div>
          ) : (
            <div className="howManyItemsInCartHidden">{itemsInCart}</div>
          )}
        </div>
