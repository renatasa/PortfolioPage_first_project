...
const shoppingItemImg = (props) => {
  switch (props.name) {
    case "Salvador Dark":
      return <img src={salvadorDark} alt={props.name} />;

    case "Organic French":
      return <img src={organicFrench} alt={props.name} />;
    case "Arabic Mocha":
      return <img src={arabicMocha} alt={props.name} />;
    case "Brazilian Cacoa":
      return <img src={brazilianCacoa} alt={props.name} />;

    case "Brazilian Cacoa Butter":
      return (
        <img
          src={brazilianCacoaButter}
          alt={props.name}
    ...
    case "Coffee":
      return <img src={coffee} alt={props.name} className="u-margin-left-2" />;
